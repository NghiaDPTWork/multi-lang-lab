  ...
  return (
    <div className="space-y-12 py-8">
      ...
      <div className="text-center space-y-6 max-w-2xl mx-auto py-12">
        ...
        <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-primary via-indigo-600 to-violet-500 bg-clip-text text-transparent">
          Welcome to ShopApp
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="hover:shadow-md transition-all duration-300 group hover:-translate-y-1 border-muted">
          <CardHeader>
            <div className="p-3 rounded-lg bg-indigo-500/10 text-indigo-600 w-fit group-hover:bg-indigo-500/25 transition-colors">
        ...
        <Card className="hover:shadow-md transition-all duration-300 group hover:-translate-y-1 border-muted">
          <CardHeader>
            <div className="p-3 rounded-lg bg-emerald-500/10 text-emerald-600 w-fit group-hover:bg-emerald-500/25 transition-colors">
        ...
        <Card className="hover:shadow-md transition-all duration-300 group hover:-translate-y-1 border-muted">
          <CardHeader>
            <div className="p-3 rounded-lg bg-amber-500/10 text-amber-600 w-fit group-hover:bg-amber-500/25 transition-colors">
