...
// Config có thêm cờ _retry để tránh loop refresh vô hạn
interface RetryConfig extends InternalAxiosRequestConfig {
  _retry?: boolean;
}

// Type mô tả instance SAU KHI interceptor đã unwrap response.data.data
// Vì response interceptor trả về T trực tiếp (không còn bọc AxiosResponse),
// nên phải khai báo lại type ở đây để không phải ép kiểu (as unknown as)
// ở tất cả các nơi gọi apiClient.post/get/...
